  ...
  return (
    <div className="container mx-auto p-3 sm:p-4">
      <div className="cosmic-card w-full max-w-xs sm:max-w-sm md:max-w-md mx-auto">
        <h1 className="gradient-text mb-6 sm:mb-8 text-center">Sign Up for DeFiOrbit</h1>
        ...
        <p className="text-starlight mt-4 sm:mt-6 text-center text-xs sm:text-sm">
          Already have an account? <Link to="/login" className="text-nebula hover:underline">Login</Link>
        </p>
      </div>
    </div>
  );
